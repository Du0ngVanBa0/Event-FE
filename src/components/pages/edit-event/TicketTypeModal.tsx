...
const TicketTypeModal: React.FC<TicketTypeModalProps> = ({
    ...
    const getZoneKey = (zone: KhuVucEventRequest) => {
        return zone.maKhuVucMau; // Always use template ID as key
    };
    ...
    useEffect(() => {
        if (editTicket) {
            setFormData({
                ...
                maKhuVuc: editTicket.maKhuVuc || '', // This should now be template ID
    ...
    const handleZoneChange = (maTemplate: string) => {
        ...
        setFormData(prev => ({
            ...prev,
            maKhuVuc: maTemplate, // Use template ID
                                ...
                                {availableZones.map((zone) => {
                                    ...
                                    return (
                                        <div 
                                            ...
                                            onClick={() => !isUsed && handleZoneChange(zoneKey)}
